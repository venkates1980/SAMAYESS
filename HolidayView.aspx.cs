...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //venkat
        //string StrSql = "select HolidayName,CompanyID,HolidayDate,Remarks from TK_Holiday where CompanyID=" + CompanyID;
        string StrSql = "select HolidayName,HolidayDate from TK_Holiday where CompanyID='"+CompanyID+"' and HolidayDate between '01jan2014' and '31dec2014' order by HolidayDate";
        //uncomment by venkat

        GridView1.DataSource = GlobalFill.FillDataTable(StrSql);
        GridView1.DataBind();

        string strsqls = "select AttendanceDate,EmployeeID, Holiday from TK_Attendance where EmployeeID='"+EmployeeID.ToString()+"' and Holiday='1' and AttendanceDate between '01jan2014' and '31dec2014'";
        GridView2.DataSource = GlobalFill.FillDataTable(strsqls);
        GridView2.DataBind();
