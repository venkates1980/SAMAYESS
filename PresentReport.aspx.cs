...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void Button7_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = GetPresentReportData(Convert.ToDateTime(txtAttendanceDate.Value ),departmentid  , "", "" );
        GridView1.DataSource = dt ;
        GridView1.DataBind();
    }
    public DataTable GetPresentReportData(DateTime mattendancedate, string mDepartmentIDStr, string mShiftIDStr, string mLocationIDStr)
    {
        ...
        ObjReporter.GetStr(false, Convert.ToInt64(GInf.CompanyID   ))      + " WHERE  (STATUS = 'P' OR STATUS = 'PX') ";
