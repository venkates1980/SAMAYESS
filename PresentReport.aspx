<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="PresentReport.aspx.cs" Inherits="Default2" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <input runat ="server"   name="txtAttendanceDate"
       ...
       type="text" id="txtAttendanceDate" style="width: 120px"/></td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
      ...
      <asp:DropDownList ID="ddlDepartment" runat="server" Height="20px" 
          Width="227px" onselectedindexchanged="ddlDepartment_SelectedIndexChanged">
    </asp:DropDownList>
                    &nbsp;&nbsp;&nbsp;
                </td>
                <td>
